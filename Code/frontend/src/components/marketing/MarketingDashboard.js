...
function MarketingDashboard() {
    ...
    useEffect(() => {
        debugger;
        axios
            .get("http://localhost:5000/api/v1/getCampaign")
            .then((res) => {
    ...
    function handleSearch(searchItem) {
        const results = DuplicateAdvertisements?.filter((advertisement) => {
            return advertisement?.ItemCode.toLowerCase().includes(
    ...
    function remove(_id) {
        axios
            .delete("http://localhost:5000/api/v1/deleteCampaign/" + _id)
            .then(() => {
                Swal.fire({
                    title: "Success!",
    ...
    function edit(
        ...
        reactLocalStorage.setObject("MarketingEdit", [
            CampaignID,
            ItemCode,
            ItemName,
            MediaType,
                ...
                >
                    <a href="/">
                        ...
                        <h4
                            ...
                            style={{ color: "black" }}
                        >
                            <i class="fas fa-home"></i>Marketing and Sales
                            Department
                        </h4>
                    </a>
                    <hr />
                    ...
                    >
                        ...
                        <MDBRow style={{ marginTop: "1%" }}>
                            <MDBCol sm="4">
                                <a href=" ">
                                    <MDBCard
                                        className=" bg-success square border-bottom border-5 border-dark bgdigram "
                                        style={{
                                            boxShadow: "2px 3px 5px #BBBBBB",
                                        }}
                                    >
                                        <MDBCardHeader
                                            className=" fw-bold mt-2 h3 pl-2 pt-5 pb-4 text-center text-uppercase"
                                            style={{ color: "white" }}
                                        >
                                            <MDBIcon className="text-muted" />{" "}
                                            {ActiveCount}
                                            <br />
                                            Active
                                        </MDBCardHeader>
                            ...
                            <MDBCol sm="4">
                                <a href=" ">
                                    <MDBCard
                                        className=" bg-primary square border-bottom border-5 border-dark bgdigram "
                                        style={{
                                            boxShadow: "2px 3px 5px #BBBBBB",
                                        }}
                                    >
                            ...
                            <MDBCol sm="4">
                                <a href=" ">
                                    <MDBCard
                                        className=" bg-warning square border-bottom border-5 border-dark bgdigram "
                                        style={{
                                            boxShadow: "2px 3px 5px #BBBBBB",
                                        }}
                                    >
